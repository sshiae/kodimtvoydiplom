...
export const SITE = {
  name: 'Кодим твой диплом',
  title: 'Помощь в написании IT-дипломов и курсовых работ',
  description:
    'Помогаем студентам разобраться в теме, подготовить IT-проект по требованиям вуза и уверенно выйти на защиту. Работаем с вами от первой строки кода до успешной защиты.',
...
export const ADVANTAGES: Advantage[] = [
  {
    ...
    description:
      'Никаких шаблонов и копипасты. Каждый проект разрабатывается совместно с нуля под ваше ТЗ и методичку.',
    icon: ShieldCheck,
  },
  {
    title: 'Исходники на GitHub',
    description:
      'Предоставляем приватный репозиторий с историей коммитов, README и документацией.',
    icon: Github,
  },
  {
    title: 'Сопровождение до защиты',
    description:
      'Помогаем разобраться с вопросами научного руководителя и комиссии, готовим вас к выступлению.',
    icon: LifeBuoy,
  },
  {
    title: 'Презентация и доклад',
    description:
      'Помогаем подготовить слайды, тезисы и раздаточный материал, чтобы защита прошла на отлично.',
    icon: Presentation,
  },
  {
  ...
  },
  {
    ...
    description:
      'Вносим правки по замечаниям руководителя в рамках исходного ТЗ — без доплат и сюрпризов.',
    icon: Wrench,
  },
];
...
export const PROCESS: ProcessStep[] = [
  ...
  },
  {
    ...
    title: 'Итог и защита',
    description:
      'Предоставляем исходники, пояснительную записку, презентацию и сопровождаем вас на всех этапах защиты.',
  },
];
...
export const FAQ: FAQItem[] = [
  {
    q: 'В какие сроки вы оказываете помощь с курсовыми и дипломами?',
    a: 'Курсовые — обычно от 5 до 14 дней, дипломные работы — от 2 до 6 недель. Точный срок согласуем после ТЗ. Берём срочные задачи при наличии свободных слотов.',
  },
  {
    q: 'Какие гарантии вы даёте?',
    a: 'Договариваемся о фиксированной стоимости и сроке заранее. Бесплатно вносим правки по замечаниям руководителя в рамках ТЗ и сопровождаем вас до успешной защиты.',
  },
  {
  ...
  },
  {
    ...
    a: 'Да. По запросу подписываем NDA. Не публикуем ваши работы и не передаём один и тот же код другим клиентам.',
  },
];
