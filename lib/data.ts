...
export const TEAM: TeamMember[] = [
  ...
  },
  {
    ...
    description:
      'Отвечаю за визуальную часть, удобство и аккуратную подачу проекта. Параллельно усиливаю техническую сторону: мобильные/desktop решения, автоматизацию и ML, чтобы работа выглядела живой и не была похожа на шаблон.',
    highlights: [
