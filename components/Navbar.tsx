...
export function Navbar() {
  ...
  return (
    <div className="fixed inset-x-0 top-0 z-50">
      <div className="flex flex-wrap items-center justify-center gap-x-1.5 gap-y-0.5 bg-slate-900 px-4 py-1.5 text-center text-xs text-slate-300 sm:text-sm">
        <span>Мы продаём не готовую работу, а</span>
        <strong className="font-semibold text-white">
          помощь опытных IT-экспертов
        </strong>
        <span>
          в её написании. Все материалы предназначены для самостоятельного
          использования студентом.
        </span>
      </div>
