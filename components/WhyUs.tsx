  ...
  return (
    <Section id="why">
      <SectionHeader
        ...
        description="Помогаем разобраться в каждом аспекте проекта: объясняем архитектуру, поясняем код и готовим вас к защите так, чтобы у комиссии не осталось вопросов."
      />
